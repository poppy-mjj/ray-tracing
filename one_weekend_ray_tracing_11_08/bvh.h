...
public:
    ...
    //virtual bool bounding_box_tri(double time0, double time1, aabb& output_box) const override;
...
//bool bvh_node::bounding_box_tri(double time0, double time1, aabb& output_box) const {
//    output_box = box;
//    return true;
//}
...
bvh_node::bvh_node(const std::vector<shared_ptr<hittable>>& src_objects, size_t start, size_t end, double time0, double time1
    ...
    typedef bool (bvh_node::* conparator)(const shared_ptr<hittable> a, const shared_ptr<hittable> b);
    //bool (*comparator)(const shared_ptr<hittable> a, const shared_ptr<hittable> b);
    /*conparator comparator = (axis == 0) ? &bvh_node::box_x_compare
